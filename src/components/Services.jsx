          ...
          <Reveal key={s.code} delay={(i % 3) * 90}>
            <article className="glass-panel group h-full p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-blue-bright/40 hover:shadow-glow">
              <div className="flex items-center justify-between">
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-blue/20 to-violet/20 border border-border flex items-center justify-center text-blue-bright group-hover:text-cyan transition-colors">
