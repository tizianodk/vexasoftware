  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        aurora:
          "radial-gradient(60% 50% at 20% 20%, rgba(47,107,255,0.22), transparent 60%), radial-gradient(50% 40% at 85% 15%, rgba(139,92,246,0.18), transparent 60%), radial-gradient(40% 40% at 60% 90%, rgba(0,229,255,0.10), transparent 60%)",
      },
      boxShadow: {
